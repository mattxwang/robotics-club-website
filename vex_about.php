	...
	<body>
		...
		<div class="container">
			...
			<div class="jumbotron bg-success">
				...
				<blockquote><h1>Necessity is the mother of invention; competition is the mother of innovation.</h1></blockquote>
				<h4 style="text-align:right;">- Steve Wozniak, Co-founder of Apple</h4>
			</div>
			<div class="row">
				<div class="col-lg-6">
