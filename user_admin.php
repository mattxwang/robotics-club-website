					...
					<div class="panel panel-primary">
						<div class="panel-heading">
						 ...
						 <ul class="list-group">
							...
							<li class="list-group-item list-group-item-warning"><span class="glyphicon glyphicon-bullhorn"></span> Create a new annoucement.</li>
							<li class="list-group-item list-group-item-danger"><span class="glyphicon glyphicon-bell"></span> Create a new alert.</li>
						</ul>
					</div>
